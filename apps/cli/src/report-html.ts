import type { GateReason, ReleaseDecision, TestStatus } from "@qualityguard/core";
...
<title>QualityGuard — ${escapeHtml(result.projectName)}</title>
<style>${styles}</style>
</head>
<body>
<main>
  <header class="page-head">
    <p class="eyebrow">QualityGuard AI</p>
...
${renderFailedTests(result)}
  ...
  <footer>Generated by QualityGuard AI. Nothing here is estimated: every number comes from the diff, the policy and a real test run.</footer>
</main>
</body>
</html>
`;
